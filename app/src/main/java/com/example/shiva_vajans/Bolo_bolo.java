...
public class Bolo_bolo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bolo_bolo);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.bolo_bolo);
