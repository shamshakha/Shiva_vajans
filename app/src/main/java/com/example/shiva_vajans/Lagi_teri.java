...
public class Lagi_teri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lagi_teri);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.lagi_teri);
