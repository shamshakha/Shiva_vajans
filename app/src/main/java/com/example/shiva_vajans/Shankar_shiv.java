...
public class Shankar_shiv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shankar_shiv);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.shankar_shiv);
