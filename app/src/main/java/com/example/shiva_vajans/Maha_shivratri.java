...
public class Maha_shivratri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maha_shivratri);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.maha_shivratri);
