...
public class Bhola_bhandari extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhola_bhandari);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.bhola_bhandari);
