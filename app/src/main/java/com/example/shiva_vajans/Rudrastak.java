...
public class Rudrastak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rudrastak);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.rudrashtak);
