...
public class Satyam_shivam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_satyam_shivam);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.satyam_shivam);
