...
public class Jyotirlingg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jyotirlingg);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.jyotirling);
