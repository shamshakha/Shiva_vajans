...
public class Jaikal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jaikal);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.jaikal_mahakal);
