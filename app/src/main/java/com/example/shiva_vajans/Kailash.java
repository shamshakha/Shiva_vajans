...
public class Kailash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kailash);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.kailash_mein_baje);
