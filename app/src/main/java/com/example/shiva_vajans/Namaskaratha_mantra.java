...
public class Namaskaratha_mantra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_namaskaratha_mantra);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.namaskaratha_mantra);
