...
public class Shankara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shankara);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.shankara);
