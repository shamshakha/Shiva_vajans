...
public class Bam_lahri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bam_lahri);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.bam_lahiri);
