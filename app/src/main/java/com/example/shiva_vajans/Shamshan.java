...
public class Shamshan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shamshan);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.shamsan);
