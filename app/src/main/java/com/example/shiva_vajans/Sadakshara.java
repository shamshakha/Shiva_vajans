...
public class Sadakshara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sadakshara);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.shiv_sadakshari);
