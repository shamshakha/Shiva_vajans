...
public class Shiv_omkara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shiv_omkara);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.shiv_omkara);
