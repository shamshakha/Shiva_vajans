...
public class Mritunjay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mritunjay);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.mahamrityunjay_mantra);
