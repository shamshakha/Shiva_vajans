...
public class Dwadash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dwadash);
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.dwadash_jyotirling);
